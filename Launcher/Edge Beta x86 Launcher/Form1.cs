...
namespace Edge_Beta_x86_Launcher
{
    public partial class Form1 : Form 
    {
        ...
        private void Button1_Click(object sender, System.EventArgs e)
        {
            ...
            {
                File.WriteAllText(@"Edge Beta x86\Profile.txt", "--user-data-dir=\"profile\"");
                this.Close();
            }
            if (radioButton2.Checked)
            {
                File.WriteAllText(@"Edge Beta x86\Profile.txt", "--user-data-dir=\"Edge Beta x86\\profile\"");
                this.Close();
            }
            if (radioButton3.Checked)
            {
                File.WriteAllText(@"Edge Beta x86\Profile.txt", "");
                this.Close();
            }
        }
    }
