...
namespace Edge_Dev_x86_Launcher
{
    public partial class Form1 : Form 
    {
        ...
        private void Button1_Click(object sender, System.EventArgs e)
        {
            ...
            {
                File.WriteAllText(applicationPath + "\\Edge Dev x86\\Profile.txt", "--user-data-dir=\"profile\"");
                this.Close();
            }
            if (radioButton2.Checked)
            {
                File.WriteAllText(applicationPath + "\\Edge Dev x86\\Profile.txt", "--user-data-dir=\"Edge Dev x86\\profile\"");
                this.Close();
            }
            if (radioButton3.Checked)
            {
                File.WriteAllText(applicationPath + "\\Edge Dev x86\\Profile.txt", "");
                this.Close();
            }
        }
    }
